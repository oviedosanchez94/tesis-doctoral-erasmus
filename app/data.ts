...
export const projectContext = {
  ...
  paises: [
    { name: 'Alemania', flag: '🇩🇪', value: 13 },
    { name: 'Polonia', flag: '🇵🇱', value: 9 },
    { name: 'Italia', flag: '🇮🇹', value: 8 },
    { name: 'Suecia', flag: '🇸🇪', value: 6 },
    { name: 'Austria', flag: '🇦🇹', value: 5 },
    { name: 'Bélgica', flag: '🇧🇪', value: 4 },
    { name: 'Grecia', flag: '🇬🇷', value: 4 },
    { name: 'Turquía', flag: '🇹🇷', value: 4 },
    { name: 'Reino Unido', flag: '🇬🇧', value: 3 },
    { name: 'Portugal', flag: '🇵🇹', value: 2 },
    { name: 'Francia', flag: '🇫🇷', value: 1 },
    { name: 'Luxemburgo', flag: '🇱🇺', value: 1 },
    { name: 'Lituania', flag: '🇱🇹', value: 1 },
  ],
  brexit: [
