      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-8">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-3">
          {[
            ...
            { color: '#7a0022', label: 'Sesgo ciclo programático', sub: 'La investigación existente analiza ciclos anteriores a 2021-2027 sin considerar las especificidades del diseño renovado y las KA122' },
          ].map((b) => (
